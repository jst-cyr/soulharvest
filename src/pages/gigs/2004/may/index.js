      ...
      <div className={styles.row}>
        <center>
          <table border="0" cellPadding="0" cellSpacing="0" width="60%" cols="2">
            <tbody>
              <tr>
                <td><div className={calendarStyles.dates}><b><a href="/gigs/2004/april/">APR</a> | <a href="/gigs/2004/september/">SEPT</a></b></div></td>
                <td align="right">
                  <div className={calendarStyles.month}>May 2004</div>
                </td>
              </tr>
              <tr>
                <td colSpan="2">
