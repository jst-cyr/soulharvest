      ...
      <div className={styles.row}>
        <center>
          <table border="0" cellPadding="0" cellSpacing="0" width="60%" cols="2">
            <tbody>
              <tr>
                <td><div className={calendarStyles.dates}><b><a href="/gigs/2003/september/">SEPT</a> | <a href="/gigs/2003/november/">NOV</a></b></div></td>
                <td align="right">
                  <div className={calendarStyles.month}>October 2003</div>
                </td>
              </tr>
              <tr>
                <td colSpan="2">
                  <table border="1" cellPadding="2" cellSpacing="0" className={calendarStyles.dates}>
                    ...
                    <tr valign="top" align="center"> 
                      ...
                      <td> 23</td>
                      <td> 24</td>
                      <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2003/october/25.html')}>
                        <a><b>25<br />
                        Olivers<br />
			                  9:00pm</b></a><br />
			                  <br />
