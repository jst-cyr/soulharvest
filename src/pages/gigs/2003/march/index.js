      ...
      <div className={styles.row}>
        <center>
          <table border="0" cellPadding="0" cellSpacing="0" width="60%" cols="2">
            <tbody>
              <tr>
                <td><div className={calendarStyles.dates}><b><a href="/gigs/2002/august/">2002</a> | <a href="/gigs/2003/september/">SEP</a></b></div></td>
                <td align="right">
                  <div className={calendarStyles.month}>March 2003</div>
                </td>
              </tr>
              <tr>
                <td colSpan="2">
                  <table border="1" cellPadding="2" cellSpacing="0" className={calendarStyles.dates}>
                    ...
                    <tr valign="top" align="center">
                      ...
                      <td> 3</td>
                      <td> 4</td>
                      <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2003/march/5.html')}>
                        <a><b>5<br />
                        Babylon<br />
			                  9:30pm</b></a><br />
			                  <br />
