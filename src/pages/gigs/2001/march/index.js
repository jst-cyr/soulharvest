      ...
      <div className={styles.row}>
        <center>
          <table border="0" cellPadding="0" cellSpacing="0" width="60%" cols="2">
            <tbody>
              <tr>
                <td><div className={calendarStyles.dates}><b><a href="/gigs/2001/february/">FEB</a> | <a href="/gigs/2001/april/">APR</a></b></div></td>
                <td align="right">
                  <div className={calendarStyles.month}>March 2001</div>
                </td>
              </tr>
              <tr>
                <td colSpan="2">
                  <table border="1" cellPadding="2" cellSpacing="0" className={calendarStyles.dates}>
                    ...
                    <tbody>
                      <tr valign="top" align="center">
                        ...
                        <td>1<br /><br /><br /></td>
                        <td>2</td>
                        <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2001/march/3.html')}>
                          <a><b>3<br />
                          O'BRIENS<br />
                          9:30pm<br /></b></a>
                        </td>
                      ...
                      <tr valign="top" align="center">
                        ...
                        <td>6</td>
                        <td>7</td>
                        <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2001/march/8.html')}>
                          <a><b>8<br />
                          CCP<br />
                          9:30pm<br /></b></a>
                        </td>
                      ...
                      <tr valign="top" align="center">
                        ...
                        <td>20</td>
                        <td>21</td>
                        <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2001/march/22.html')}>
                          <a><b>22<br />
                          CCP<br />
                          9:30pm<br /></b></a>
                        </td>
