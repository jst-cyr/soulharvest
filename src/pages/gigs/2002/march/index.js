      ...
      <div className={styles.row}>
        <center>
          <table border="0" cellPadding="0" cellSpacing="0" width="60%" cols="2">
            <tbody>
              <tr>
                <td><div className={calendarStyles.dates}><b><a href="/gigs/2001/december/">2001</a> | <a href="/gigs/2002/may/">MAY</a></b></div></td>
                <td align="right">
                  <div className={calendarStyles.month}>March 2002</div>
                </td>
              </tr>
              <tr>
                <td colSpan="2">
                  <table border="1" cellPadding="2" cellSpacing="0" className={calendarStyles.dates}>
                    ...
                    <tr valign="top" align="center"> 
                      ...
                      <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2002/march/30.html')}>
                        <a><b>30<br />
                        Bumpers<br />
			                  9:30pm</b></a><br />
			                  <br />
