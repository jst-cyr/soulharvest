      ...
      <div className={styles.row}>
        <center>
          <table border="0" cellPadding="0" cellSpacing="0" width="60%" cols="2">
            <tbody>
              <tr>
                <td><div className={calendarStyles.dates}><b><a href="/gigs/2002/march/">MARCH</a> | <a href="/gigs/2002/june/">JUNE</a></b></div></td>
                <td align="right">
                  <div className={calendarStyles.month}>May 2002</div>
                </td>
              </tr>
              <tr>
                <td colSpan="2">
                  <table border="1" cellPadding="2" cellSpacing="0" className={calendarStyles.dates}>
                    ...
                    <tr valign="top" align="center">
                      ...
                      <td> 7</td>
                      <td> 8</td>
                      <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2002/may/9.html')}>
                        <a><b>9<br />
                        Café Dekcuf<br />
			                  9:30pm</b></a><br />
			                  <br />
                    ...
                    <tr valign="top" align="center"> 
                      ...
                      <td> 29</td>
                      <td> 30</td>
                      <td bgcolor="#76A7CB" onClick={() => gigInfo('/gigs/2002/may/31.html')}>
                        <a><b>31<br />
                        Bumpers<br />
			                  9:30pm</b></a><br />
			                  <br />
