...
export default function Bio() {
  return (
    <div>
      <Head>
        <title>Soul Harvest - Band Biography and Press Kit</title>
      </Head>
      ...
      <div className={styles.row}>
          ...
          <p>
            The opening track on the CD, entitled "Stumbled" is a hard rock song that gains its strength from skillful guitar work by rhythm guitarist Ryan Lindsay and lead guitarist <img src="/pics/rec_rift/studiojay2_s.jpg" width="100" height="100" align="right" border="0" hspace="2" vspace="2" />Sean McCullough.  The poignant lyrics, written by bassist Jason St-Cyr, have a cyclical quality and the song ends almost where it began: "You need to see my face again, and you say / You need me...I need to see your face again, and I think/ I need you".
          </p>
          <p>
            Next comes "Take Your Time", a song that demonstrates the vocal <img src="/pics/rec_rift/studiochris2_s.jpg" width="100" height="100" align="left" border="0" hspace="2" vspace="2" />capabilities of lead singer Dave Van Soest and provides him with the opportunity to infuse the song with a good measure of emotion.  It's a solid rock song, supported by strong percussion and excellent guitar playing.
          </p>
          <p>
          Written by drummer Chris Amos, "Wanna Go Home" is an interesting song that holds the listener's attention throughout with its constant tempo changes.  <img src="/pics/rec_rift/studiosean_s.jpg" width="100" height="100" align="right" border="0" hspace="2" vspace="2" /> It's got a very clean sound and is a polished offering from the group.
          </p>
          <p>
          ...
          <p>
          <img src="/pics/rec_rift/studioband3_s.jpg" width="100" height="100" align="right" border="0" hspace="2" vspace="2" />
          ...
          <p>
            <img src="/pics/rec_rift/studioryan2_s.jpg" width="100" height="100" align="left" border="0" hspace="2" vspace="2" />Rounding out the collection is the blues song "She's Alright".  There is unavoidable head- bopping that occurs when listening to this song - honestly.  It's  a great ballad that manages to sound both comfortably familiar and refreshingly original.   Coming as a surprise was the mid-song introduction of each band member before his solo: a clear testament to Soul Harvest's live- performance recording style.
          </p>
          <p>
